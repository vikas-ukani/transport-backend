...
export const RegisterVehicleSchema = Joi.object({
  ...
  rcPhotos: Joi.array().min(2).items(Joi.string()).required().messages({
    "array.base": "RC book images are required.",
    "array.min": "Please upload at least two RC Book image.",
    "any.required": "Please upload RC book.",
    "array.includes": "All RC book must be valid strings.",
  }),
  ...
  imageIds: Joi.array().min(1).items(Joi.string()).required().messages({
    ...
    "array.min": "Please upload at least one truck image.",
    "any.required": "Please upload truck images.",
    "array.includes": "All truck images must be valid strings.",
  }),
...
export const CreateBookingSchema = Joi.object({
  ...
  driverNotes: Joi.optional().messages({
